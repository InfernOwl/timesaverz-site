...
import { createPlaceholder } from "../graphql/mutations";
const client = generateClient();
export default function PlaceholderCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGame_image_alt(initialValues.game_image_alt);
    setBackground_image(initialValues.background_image);
    setSweeps_winner(initialValues.sweeps_winner);
    setErrors({});
  };
  const validations = {
    game_title: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPlaceholder.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PlaceholderCreateForm")}
      {...rest}
    >
      <TextField
        label="Game title"
